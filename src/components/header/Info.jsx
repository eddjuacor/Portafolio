  ...
  return (
    <div className="flex  w-full pt-4">
      <div className="flex gap-2">
        ...
        <a href="" className="no-underline font-mono text-slate-400 hover:text-slate-600"><img src={linkedin} alt="" className=" size-6 md:size-7"/></a>
        <a href="" className="no-underline font-mono text-slate-400 hover:text-slate-600"><img src={github} alt="" className=" size-6 md:size-7" /></a>
      </div>
    </div>
  )
}
